...
1. **R-Precision**
   ...
   (The ground truth set of tracks by G, and the ordered list of recommended tracks by R.).    <br/>
   $$
...
2. **NDCG** (Normalized DCG (NDCG))
   ...
   Discounted cumulative gain (DCG) measures the ranking quality of the recommended tracks, increasing when relevant tracks are placed higher in the list. Normalized DCG (NDCG) is determined by calculating the DCG and dividing it by the ideal DCG in which the recommended tracks are perfectly ranked: <br/> 
   $$
